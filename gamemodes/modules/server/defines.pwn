...
//==============================================================================
#define ERROR_LOGGEDIN															"คุณยังไม่ได้ล็อคอิน!"
#define ERROR_ADMIN 															"คุณไม่ใช่แอดมิน"
#define ERROR_SPAM_TIME															"คำสั่งนี้ไม่สามารถทำได้ในเวลานี้"
#define ERROR_LOCATION															"คำสั่งนี้ไม่สามารถทำได้ที่ตำแหน่งนี้"
#define ERROR_MONEY																"เงินไม่เพียงพอ"
#define ERROR_ADMINLEVEL														"ไม่สามารถดำเนินการกับผู้ดูแลระบบระดับสูงกว่านี้ได้"
#define ERROR_INVALIDPLAYER														"ระบุผู้เล่นไม่ถูกต้อง"
#define ERROR_VEHICLE															"คุณต้องอยู่ในยานพาหนะเพื่อดำเนินการคำสั่งนี้"
#define ERROR_FACTION 															"คุณไม่มีสิทธิ์เข้าถึงคำสั่งนี้"
#define ERROR_VALUE																"ไม่สามารถใช้ได้ในขณะนี้"
#define ERROR_OPTION															"ตัวเลือกไม่ถูกต้อง"
#define ERROR_DIALOG															"Dialog ถูกปิด"
#define ERROR_RANK																"คุณมีตำแหน่งไม่เพียงพอ"
#define ERROR_MUTED																"คุณถูกใบ้"
#define ERROR_OWNED																"คุณเป็นเจ้าของรายการประเภทนี้แล้ว"
#define ERROR_OWNER																"รายการนี้มีเจ้าของแล้ว"
#define ERROR_NOTOWNED															"คุณไม่ได้เป็นเจ้าของ"
#define ERROR_JOB																"คุณไม่มีงานที่ต้องทำ"
#define ERROR_CONNECTED															"ผู้เล่นที่คุณร้องขอไม่ได้เชื่อมต่อ"
